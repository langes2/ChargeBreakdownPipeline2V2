...
def modify_excel_file(input_file):
    ...
    columns_to_drop = [2, 5, 6, 8, 12, 14, 16, 19, 22, 25, 27, 28]
...
def main():
    ...
    # Define the search pattern for files that contain "frag1", "frag2", "frag3", or "frag4" in the filename
    search_patterns = ["*frag1*.xlsx", "*frag2*.xlsx", "*frag3*.xlsx", "*frag4*.xlsx"]
